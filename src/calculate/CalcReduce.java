...
public class CalcReduce extends Reducer<Text, Text, Text, Text> {
    ...
    protected void setup(Context context) throws IOException, InterruptedException {
        ...
        ScaledDanglingSum = currentJob.getCounters().findCounter(PageRanking.counterTypes.DANGLINGSUM).getValue(); 
        DanglingSum = ScaledDanglingSum / SCALING_COUNTER;
        ErrorSum = 0.0;
        System.out.println("[CalcReducer Setup] GlobalNum: " + GlobalNum);
    ...
    public void reduce(Text page, Iterable<Text> values, Context context) throws IOException, InterruptedException {
        ...
        newPageRank = (Double) ( (1 - DAMPING_FACTOR)  / GlobalNum ) +  DAMPING_FACTOR * (newPageRankSum +  (Double) DanglingSum / GlobalNum);
        System.out.println("[calcReducer] ErrorSum: " + ErrorSum);

        System.out.println("[calcReducer] (1st item): " + (Double) ( 0.15 / GlobalNum ));
	...
	protected void cleanup(Context context) throws IOException, InterruptedException {
        ...
        // scaledDelta = 100L;
        context.getCounter(PageRanking.counterTypes.DANGLINGSUM).setValue(0L);
        context.getCounter(PageRanking.counterTypes.ERROR).setValue(scaledDelta);
	}
}
